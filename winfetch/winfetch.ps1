...
$img = if (-not $noimage) {
    if ($image) {
        ...
        } elseif ($logo -eq "Bocchi") {
            $COLUMNS = 35
            @(
                ""
                ""
                ""
                "    ${e}[${t};38;2;238;212;159m  ⣠⣤⣄⣾⣿⡷⣠⣴⣶⣿⣿⣿⣿⣿⣿⣷⣶⣤⡀",
                "    ${e}[${t};38;2;238;212;159m ⣼⠋⠀⣾⡟⣳⣾⣿⡿⣿⣿⣿⠟⣿⣿⣿⣿⣿⣿⣿⣷⣄",
                "    ${e}[${t};38;2;245;169;127m ⡇⠀⠀⠉⢱⣿⣿⡿⢰⣿⣿⠃⢰⣿⣿⣿⣿⣿⡟⢿⣿⣿⣷",
                "    ${e}[${t};38;2;245;169;127m ⠁⠀⠀⠀⣿⣿⣿⠇⣼⣿⠇⡀⢸⡿⣿⣿⣿⡿⠁⢸⣿⣿⣿⡇",
                "    ${e}[${t};38;2;237;135;150m ⠀⠀⠀⢰⢰⣿⡿⢀⣸⣿⣤⣿⡈⡇⢿⣿⡿⢁⡎⢸⣿⡇⣿⣿",
                "    ${e}[${t};38;2;237;135;150m ⠀⠀⠀⣼⢸⣿⡇⣸⣤⣶⣶⣤⣽⣷⣼⡯⠐⠿⢇⣿⡿⠀⣿⣿",
                "    ${e}[${t};38;2;245;189;230m ⠀⠀⠀⣿⣿⣿⡇⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⣦⣹⡦⠂⣿⣿",
                "    ${e}[${t};38;2;245;189;230m ⠀⠀⠀⣿⡁⣿⡇⠻⣿⣿⣿⣧⣙⠛⣛⣿⣿⣿⣿⣿⠡⠂⣿⡏",
                "    ${e}[${t};38;2;198;160;246m ⠀⠀⠀⣿⣧⣙⡇⠲⢀⣉⠛⠛⠿⠿⠿⣿⣿⡿⠿⠋⣴⢀⣿⠃",
                "    ${e}[${t};38;2;198;160;246m ⠀⠀⣸⣿⡿⣿⡟⢠⣿⣿⢷⣦⢠⣤⣤⣤⠰⣶⣶⣿⠃⣼⣡",
                "    ${e}[${t};38;2;138;173;244m ⠀⢠⣿⡿⢠⣿⢡⣿⣿⠃⣾⡇⣸⢸⣿⣿⡇⡿⢿⣿⣿⣿⣿"
            )
        } else {
